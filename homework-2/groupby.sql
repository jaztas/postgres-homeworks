...
FROM orders WHERE ship_country LIKE 'P%' ORDER BY freight DESC LIMIT 10
...
SELECT country, COUNT(supplier_id) AS count_supplier
FROM suppliers GROUP BY country ORDER BY count_supplier DESC
